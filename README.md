## This new version adds an experimental install script based on the EZARCH scripting system by Eznix.
...
You can download the latest testing image from the [Blind Computing download page](https://downloads.blindcomputing.org/blindarch/BlindArch-2020.12.01-x86_64.iso).
