...
You can download the latest testing image from the [Blind Computing download page](https://downloads.blindcomputing.org/blindarch/BlindArch-2020.12.10-x86_64.iso).
